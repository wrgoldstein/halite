...
while True:
    ...
    for ship in me.get_ships():
        ...
        if game.turn_number > constants.MAX_TURNS - 20:
        ...
        elif ship.halite_amount > .55*constants.MAX_HALITE:
            ...
            surrounds = ship.position.get_n_surrounding_cardinals(7)
    ...
    if game.turn_number <= constants.MAX_TURNS*.6 and me.halite_amount >= constants.SHIP_COST and not game_map[me.shipyard].is_occupied:
